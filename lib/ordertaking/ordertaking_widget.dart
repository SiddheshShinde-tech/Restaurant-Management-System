...
class OrdertakingWidget extends StatefulWidget {
  const OrdertakingWidget({Key key}) : super(key: key);

  @override
  _OrdertakingWidgetState createState() => _OrdertakingWidgetState();
}

class _OrdertakingWidgetState extends State<OrdertakingWidget> {
