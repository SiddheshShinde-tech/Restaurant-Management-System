...
class REButtonOptions {
  const REButtonOptions({
    this.textStyle,
    this.elevation,
    this.height,
    this.width,
...
class REButtonWidget extends StatefulWidget {
  ...
  final REButtonOptions options;
  final bool showLoadingIndicator;

  @override
  State<REButtonWidget> createState() => _REButtonWidgetState();
}

class _REButtonWidgetState extends State<REButtonWidget> {
  bool loading = false;
      ...
      return Container(
        ...
        child: ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
            ...
            textStyle: TextStyle(color: widget.options.textStyle.color,),
