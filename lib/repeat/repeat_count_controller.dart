...
class RepEatCountController extends StatefulWidget {
  const RepEatCountController({
    Key key,
  ...
  @override
  _RepEatCountControllerState createState() => _RepEatCountControllerState();
}

class _RepEatCountControllerState extends State<RepEatCountController> {
