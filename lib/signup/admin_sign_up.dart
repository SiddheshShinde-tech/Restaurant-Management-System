...
import '../signin/admin_signin_widget.dart';
...
class _SignUpWidgetState extends State<SignUpWidget> {
  ...
  var authenticationServices = AdminSupabaseServices();
  ...
  var budgetValue;
  var dbOperations = new AdminSupabaseServices();
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: SingleChildScrollView(
          child: AppBar(
            backgroundColor: RepEatTheme.of(context).secondaryBackground,
          ...
          children: [
            ...
            Padding(
              ...
              child: RepEatDropDown(
                options: ["manager", "server", "chef"].toList(),
            ...
            Padding(
              ...
              child: REButtonWidget(
                onPressed: () async {
                  ...
                  final isAuthenticated = await authenticationServices.signUp(
                  ...
                  if (phoneVal.isEmpty || phoneVal.length != 10) {
                    ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Phone number Invalid!')));
                    return;
                  }
                  ...
                  if (isAuthenticated == true &&
                    ...
                    dbOperations.insertDataToAdmins(nameVal, phoneVal, user);
                    print("executedDbOperations");
